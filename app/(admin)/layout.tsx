...
export default function DashboardLayout({children}: { children: React.ReactNode }) {
    ...
    const menuElements = [
        {
            key: 'dashboard',
            icon: <Image src="/images/icons/dashboard-2-svgrepo-com.png" alt="" width={28}
                         height={28}/>,
            label: 'Dashboard',
        ...
        {
            key: 'roles',
            icon: <Image src="/images/icons/user-role-svgrepo-com.png" alt="" width={28}
                         height={28}/>,
            label: 'Roles',
            href: '/admin/roles',
        },
        ...
        },
        {
            key: 'exercises',
            icon: (
                <Image src="/images/icons/exercise-game-6-svgrepo-com.png" alt="" width={28}
                       height={28}/>
            ),
            label: 'Ejercicios',
        ...
        {
            key: 'categories',
            icon: <Image src="/images/icons/category-2-svgrepo-com.png" alt="" width={28}
                         height={28}/>,
            label: 'Categorías',
        ...
        {
            key: 'pilates',
            icon: <Image src="/images/icons/pilates-3-svgrepo-com.png" alt="" width={28}
                         height={28}/>,
            label: 'Pilates',
            href: '/admin/pilates',
        },
        {
            key: 'monitor',
            icon: <Image src="/images/icons/monitor-two-svgrepo-com.png" alt="" width={28}
                         height={28}/>,
        ...
        },
        {
            ...
            icon: <Image src="/images/icons/next-998-svgrepo-com.png" alt="" width={28}
                         height={28}/>,
