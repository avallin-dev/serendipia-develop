...
import { ClassCard } from './_components'
import { RecoveryCard } from './_components'
...
export default function Page() {
  ...
  return (
    <div className="pb-2 lg:pb-0">
        ...
        <>
          ...
          <div className="space-y-2 py-2">
            {partnerMembership.map((item) => (
              <h3 key={item.id} className="text-base font-medium text-magenta lg:text-xl">
      ...
      <div className="flex w-full flex-col-reverse gap-2 overflow-x-auto lg:min-h-[calc(100vh-180px)] lg:flex-row">
        ...
        <div className="p-2 lg:w-1/3">
          <div className="rounded-lg border-2 border-gray-400 bg-white p-4">
            ...
            <div className="mt-10 grid grid-cols-7 text-center text-base font-medium leading-6 text-gray-600 sm:text-lg">
              <div>Dom</div>
              <div>Lun</div>
              <div>Mar</div>
              <div>Mié</div>
              ...
              {days.map((day, dayIdx) => (
                ...
                >
                  ...
                  <div className="mx-auto mt-1 h-1 w-1">
                    ...
                    }) && <div className="h-2 w-2 self-center rounded-full bg-sky-500"></div>}
                  </div>
                </div>
              ))}
            </div>
