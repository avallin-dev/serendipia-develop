...
import {differenceInWeeks, isWithinInterval, addDays} from 'date-fns'

const prisma = new PrismaClient()

/** @description bloque de código comentariado para evitar errores */
export async function setupPilatesDisponibles() {
  // try {
