...
export default function Page() {
  ...
  const [timer, setTimer] = useState(current.getMinutes())
  ...
  useEffect(() => {
    cleanMonitor()
    setInterval(_ => {
      setTimer(current.getMinutes())
    }, 60000)
    if (!isLoading && data) {
      applyFilters(activeFilters)
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isLoading, isFetching, data, activeFilters, statusFilter, timer])
    ...
    <div>
      ...
      {filteredData.length > 0 ? (
            ...
            filteredData.map((item) => (
              ...
              >
                <Checkbox
                  ...
                  color="#FFFF00"
                />
                <div style={{ visibility: item.porcentajeProgreso == 0? 'visible': 'hidden'}}>
                <Button variant="outline" className={cn('absolute -bottom-[1.5em] left-[40%] right-[40%] animate-pulse hover:animate-none hover:bg-primary-foreground hover:text-white border-0')}
                ...
                <div className="flex gap-x-6">
                  ...
                  <div className="mb-2 space-y-2">
                    ...
                    <div>
                      <span className="font-bold">Tipo de entrenamiento:</span>{' '}
        ...
        <div className="flex h-full flex-col items-center justify-center p-6 text-center">
          ...
          <h2 className="mt-4 text-xl font-semibold text-gray-800">No hay socios registrados</h2>
          <p className="mt-2 max-w-md text-sm text-gray-500">
            Aún no hay socios registrados en el sistema. Los miembros deben ingresar mediante el
