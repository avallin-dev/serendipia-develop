  ...
  return (
    <>
      ...
      <div className="relative">
        <div className="grid grid-cols-2 grid-rows-2 gap-x-3 gap-y-3 lg:grid-cols-profile xl:gap-x-8">
          <div
            ...
            <div>
              ...
              <div className="text-center text-sm font-light text-secondary-dark">DNI: {dni}</div>
              <div className="h-5"></div>
              {plan?.usuario?.Telefono && (
                <>
                  <div className="mb-2 text-center text-sm">
                    ¿Tenes dudas sobre algún ejercicio o comentarios sobre el plan de entrenamiento?
                  </div>
                  <Link
                    target="_blank"
          ...
          <div className="border-gallery-100 col-span-2 space-y-6 rounded-lg border bg-white px-5 py-8 sm:col-auto">
            ...
            <div className="flex items-center gap-x-5">
              <Image src="/images/icons/altura_icon.png" alt="" width={26} height={26} />
              <div>
          ...
          <div className="border-gallery-100 col-span-2 rounded-lg border bg-white px-5 py-8  sm:col-auto">
            {memberships ? (
              <>
                <div className="text-center text-xl font-semibold">
                  {memberships?.membresia?.Nombre}
                </div>
                <div className="text-center font-light text-[#6A6A6A]">Membresia actual</div>
                ...
                <div className="h-5"></div>
                <div
                  className="mx-auto flex h-11 w-24 items-center justify-center rounded bg-secondary text-sm font-medium text-white">
                  {memberships?.estadoMembresia}
                </div>
                  <MercadoPagoButton
                    idSocio={id}
              ...
              <div className="text-center text-xl font-semibold">No hay membresia</div>
            )}
          </div>
          <div className="border-gallery-100 col-span-2 rounded-lg border bg-white px-5 py-8">
