  ...
  return (
    <div className="flex">
      ...
      <section className="flex min-h-svh w-full flex-col bg-alabaster md:ml-16 md:w-[calc(100%-4rem)]">
        <header className="flex h-[70px] w-full items-center justify-between gap-x-3 bg-mine-shaft-900 md:h-24 md:justify-end md:px-7">
        ...
        <div className="flex-grow overflow-y-auto overflow-x-hidden">
          <div className="px-2 py-6 sm:px-6">{children}</div>
        </div>
      </section>
    </div>
  )
