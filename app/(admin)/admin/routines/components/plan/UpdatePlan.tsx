...
import { useUpdatePlan } from '@/app/services/mutations/plan'
...
export default function UpdatePlan({ onClose, open, plan }: ModalCreateMembershipProps) {
  ...
  async function onSubmit(values: planSchmaType) {
    ...
    updatePlanMutation.mutate(
      { data: { ...values, fechaCreacion: formatUTC(values.fechaCreacion) }, id: id! },
      {
        onSuccess() {
          queryClient.invalidateQueries({
            queryKey: ['plan', plan?.idSocio?.toString()],
          })
